...
export function AppLayout() {
  ...
  return (
    <div className="relative min-h-svh">
      ...
      <SeloMissao1BIWatermark side="left" imgClassName="w-[min(340px,32vw)] opacity-[0.06]" />
      <SeloMissao1BIWatermark side="right" imgClassName="w-[min(340px,32vw)] opacity-[0.06]" />
